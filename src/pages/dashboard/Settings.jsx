  ...
  return (
    <div className="w-full space-y-10">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              type="email"
              defaultValue="charles@example.com"
              className="mt-1 w-full border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#00477B]"
            />
          </div>
        </div>
      ...
      >
        ...
        <p className="text-sm text-red-600 mb-4">Deleting your account is irreversible. Please proceed with caution.</p>
